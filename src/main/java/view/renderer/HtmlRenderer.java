...
public class HtmlRenderer {
    ...
    private final String USER_NAME_TAG_FORMAT = "<li><a>%s 님</a></li>\n";
    ...
    public String decorateHeaderBar(String html, Map<String, Object> model) {
        ...
        if (login) {
            ...
            // 로그아웃 버튼 O
            // 개인정보 수정 버튼 O
            html = replaceTag(html, "userName", userNameTag);
            html = replaceTag(html, "login", "");
