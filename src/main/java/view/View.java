...
public class View {
    ...
    public byte[] list(Map<String, Object> viewParameters) {
        List<UserResponse> users = (List<UserResponse>) viewParameters.get("users");
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("<!DOCTYPE html>\n");
        stringBuilder.append("<html lang=\"kr\">\n");
        stringBuilder.append("<head>\n");
    ...
    private void makeLoginForm(Map<String, Object> viewParameters, StringBuilder stringBuilder) {
        ...
        if (name != null) {
            stringBuilder.append("                        <li><a href=\"#\" role=\"button\">").append(name).append("님</a></li>\n");
            stringBuilder.append("                        <li><a href=\"#\" role=\"button\">로그아웃</a></li>\n");
            stringBuilder.append("                        <li><a href=\"#\" role=\"button\">개인정보수정</a></li>\n");
        } else {
            stringBuilder.append("                        <li><a href=\"user/login.html\" role=\"button\">로그인</a></li>\n");
