...
public class PostShowView implements View {
    ...
    public String render(HttpRequest request, HttpResponse response, Model model) {
        ...
        stringBuilder
                ...
                .append("              <h2 class=\"qna-title\">").append(model.getAttribute("title")).append("</h2>")
                .append("          </header>")
                ...
                .append("                          <a href=\"/users/92/").append(model.getAttribute("writer")).append("\" class=\"article-author-name\">").append(model.getAttribute("writer")).append("</a>")
                .append("                          <a href=\"/questions/413\" class=\"article-header-time\" title=\"퍼머링크\">")
                .append("                              ").append(model.getAttribute("createDateTime"))
                .append("                              <i class=\"icon-link\"></i>")
                .append("                          </a>")
                .append("                      </div>")
                .append("                  </div>")
                .append("                  <div class=\"article-doc\">")
                .append(model.getAttribute("content"))
                .append("                  </div>")
